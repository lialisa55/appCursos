        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            <a
              ...
              class="collapsed"
              data-bs-toggle="collapse"
              data-bs-target="#ddmenu_categoria"
              aria-controls="ddmenu_categoria"
              aria-expanded="false"
              aria-label="Toggle navigation"
            >
              <span class="icon">
            ...
            <ul id="ddmenu_categoria" class="collapse dropdown-nav">
              <li>
                <a href="{{route('/cadastrocategoria')}}"> Adicionar </a>
              </li>
              <li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_aula" class="collapse dropdown-nav">
              <li>
                <a href="settings.html"> Adicionar </a>
              </li>
              <li>
                <a href="blank-page.html"> Gerenciar </a>
              </li>
          ...
          <li class="nav-item nav-item-has-children">
            <a
              ...
              class="collapsed"
              data-bs-toggle="collapse"
              data-bs-target="#ddmenu_d6"
              aria-controls="ddmenu_d6"
              aria-expanded="false"
              aria-label="Toggle navigation"
            >
              <span class="icon">
